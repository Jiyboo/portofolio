...
import cvImage from "../assets/cv.png"; // pastikan file ada di src/assets/

const CV = () => {
  return (
    <div className="relative px-4 sm:px-6 lg:px-8">
      {/* Style khusus sembunyikan scrollbar */}
      <style>{`
        .hide-scrollbar {
      ...
      `}</style>
       ...
       {/* 📱 Mobile: langsung tampilkan gambar full */}
      ...
      {/* 💻 Desktop/Tablet: tampilkan versi kode */}
